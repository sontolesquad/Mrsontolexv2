...
echo "[===============================================]>"
echo $cyan "201.> Contact Me"
echo "[===============================================]>"
echo $yellow "0.> keluar"
echo "[+]===============================================[+]"
echo "\033[32;1m"
read -p "root@T00Ls-Mrsontolexv2~#" bro
...
clear
toilet "Mrsontolex"
python2 ContactMe.py
fi

if [ $bro = 0 ] || [ $bro = 00 ]
then
echo "\033[32;1mPERSIT2K18"
sleep 1
